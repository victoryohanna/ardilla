              ...
              <form className="form">
                ...
                <div className="interest-section">
                  <div className="mb-3">
                    ...
                    <span className="form-control form-control-sm">N6,600</span>
                  </div>
                  <p>
                    Saving N2000 monthly for 3 months will result ina balance of
                    N6600{" "}
                  </p>
                  <div className="mb-3">
                    <label htmlFor="amount" className="form-label">
                  ...
                  <div className="mb-3">
                    ...
                    <span className="form-control form-control-sm">N600</span>
                  </div>
                </div>
              </form>
            </div>
